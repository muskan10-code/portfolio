...
const NavBar = () => {
  ...
  return (
    <header className='w-full px-32 py-8 font-medium flex items-center justify-between dark:text-light relative z-50 lg:px-16 md:px-12 sm:px-8'>
        ...
        isOpen ?
          ...
          >
            ...
            <nav className="flex items-center justify-center flex-wrap mt-8">
              <motion.a href="https://github.com/muskan10-code" target={"_blank"} whileHover={{ y: -2 }} whileTap={{ scale: 0.9 }} className="w-6 mx-3 sm:mx-1">
