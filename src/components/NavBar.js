  ...
  return (
    <header className='w-full px-32 py-8 font-medium flex items-center justify-between dark:text-light relative z-10 lg:px-16 md:px-12 sm:px-8'>
      ...
      {/* HAMBURGER (Left on Mobile) 
          Because this is the first child in 'justify-between', it naturally sits on the Left.
      */}
        ...
        isOpen ?
          ...
          >
            ...
            <nav className="flex items-center justify-center flex-wrap mt-2">
              <motion.a href="https://github.com/muskan10-code" target={"_blank"} whileHover={{ y: -2 }} whileTap={{ scale: 0.9 }} className="w-6 mx-3 sm:mx-1"><GithubIcon /></motion.a>
              <motion.a href="https://www.linkedin.com/in/muskan-arora-swe/" target={"_blank"} whileHover={{ y: -2 }} whileTap={{ scale: 0.9 }} className="w-6 mx-3 sm:mx-1"><LinkedInIcon /></motion.a>
      ...
      {/* --- LOGO --- 
          FIX:
          1. Mobile: 'right-8 top-2' (Puts it on the Right)
          2. Desktop: 'lg:left-[50%]' (Restores Center)
      */}
      <div className='absolute right-8 top-2 lg:left-[50%] lg:translate-x-[-50%] lg:right-auto'>
        <Logo />
      </div>
    </header>
  );
